      ...
      <div className='container'>
        ...
        <div className='grid-container2'>
          <Description
            ...
            description='Coraline Jones y sus padres "workaholics" se mudan a una vieja casa que ha sido dividida en distintos pisos de departamentos. Entre los inquilinos están las señoritas Spink y Forcible, dos mujeres ancianas retiradas de la farándula del teatro, y el Señor Bob, inicialmente referido a él como "el viejo loco de arriba”, que se define como entrenador de un circo de ratones. El piso junto al de Coraline está deshabitado, y una puerta enlaza ambos departamentos, pero está bloqueada por ladrillos una vez abierta.'
          />       
          ...
          <Follow className={"content-follow-button"}/>
